...
| `docs/21_签证客户中心P0验收与Rollout说明.md` | 签证域职责边界、兼容说明、验收矩阵与 P1/P2 延续项 |
| `docs/22_材料チェックリスト口径冻結.md` | 材料 checklist 模板/实例模型、家属维度、material_status 并存规则（P1-S1a） |
| `docs/23_P1历史签证数据导入口径冻結.md` | 历史签证批量导入实体范围、客户/主申匹配、冲突幂等、权限与审计（P1-S3a） |
| `docs/24_P1历史签证数据导入验收与操作说明.md` | 导入工具操作步骤、模板示例、错误码、验收场景与非自动全量迁移声明（P1-S3e） |
